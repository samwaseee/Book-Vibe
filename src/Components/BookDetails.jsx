...
const BookDetails = () => {
    ...
    return (
        <>
            <div className="flex sans gap-10 mt-14">
                ...
                <div>
                    ...
                    <div className="flex gap-5 mt-8">
                        <button onClick={success} className="btn btn-outline"> Read </button>
                        <button onClick={error} className="btn btn-info text-white bg-[#50B1C9]">Wishlist</button>
                    </div>
                </div>
